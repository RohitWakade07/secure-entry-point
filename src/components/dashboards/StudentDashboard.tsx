          ...
          <CardContent className="grid gap-3 sm:grid-cols-3">
            <button className="flex items-center gap-3 rounded-xl border border-border p-4 text-left transition-colors hover:bg-secondary">
              ...
              <div>
                ...
                <p className="text-xs text-muted-foreground">Topic-wise practice</p>
              </div>
            </button>
            <button className="flex items-center gap-3 rounded-xl border border-border p-4 text-left transition-colors hover:bg-secondary">
              <Target className="h-5 w-5 text-emerald-500" />
              <div>
                <p className="font-medium text-sm">Mock Test</p>
                <p className="text-xs text-muted-foreground">Full-length tests</p>
              </div>
            </button>
            <button className="flex items-center gap-3 rounded-xl border border-border p-4 text-left transition-colors hover:bg-secondary">
