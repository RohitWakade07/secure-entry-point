...
import { GraduationCap, LogOut, LayoutDashboard, BookOpen, FileText, Users, Settings, Bookmark, BarChart3, HelpCircle } from "lucide-react";
...
const DashboardLayout = ({ children }: { children: ReactNode }) => {
  ...
  const navItems = {
    ...
    teacher: [
      ...
      { to: "/performance", icon: BarChart3, label: "Students" },
    ],
    admin: [
      { to: "/dashboard", icon: LayoutDashboard, label: "Dashboard" },
